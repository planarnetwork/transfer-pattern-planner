 ...
 */
async function run(patterns: string, directory: string) {
...
if (process.argv[2] && process.argv[3]) {
  ...
  console.log("Please specify a transfer pattern file and a directory to write the stations to.");
}
